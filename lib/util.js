...
getItemSignature = function(item_interface) {
    var types = item_interface.getRarity() + " ";
...
getItemSignatureHTML = function(item_interface) {
    var $signature_p = $('<p>' + item_interface.getRarity() + '</p>');
