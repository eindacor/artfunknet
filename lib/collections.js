...
beta_keys = new Mongo.Collection("beta_keys");
...
if (Meteor.isServer) {
    ...
    Meteor.publish("auctions", function() {
        ...
        return auctions.find({'viewer': {$in: [this.userId, "public"]}}, {fields: fields_object});
    });

    Meteor.publish("items", function() {
        return items.find({'owner': this.userId, "status": {$ne: "archived"}}, {fields: {
