...
RARITY_LEVEL_RESTRICTIONS = undefined;

getRarityLevelRestrictions = function() {
    if (RARITY_LEVEL_RESTRICTIONS == undefined) {
        RARITY_LEVEL_RESTRICTIONS = {
            'common': 0,
            'uncommon': 5,
            'rare': 15,
            'legendary': 30,
    ...
    return RARITY_LEVEL_RESTRICTIONS;
}