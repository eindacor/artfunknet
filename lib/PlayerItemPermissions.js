...
PlayerItemPermissions = function(player_interface, item_interface) {
	...
	this.canRedeemForgery = function() {
		return isOwnedAndClaimed() && 
			item_interface.getItemObject().authenticity.forgery && 
			item_interface.getItemObject().authenticity.identified && 
			item_interface.getItemObject().authenticity.liable != player_interface.getId();
	}
}
