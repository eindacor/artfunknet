...
PlayerItemPermissions = function(player_interface, item_interface) {
	...
	this.canSetPermanent = function() {
		if (tutorialStatusMatches() && isOwned() && !artworkIsAlreadyPermanentOrDisplayed() && ["unclaimed", "won", "for_sale"].indexOf(item_interface.getStatus()) == -1 && !item_interface.isDisplaced()) {
	...
	this.canSetRepairing = function() {
		if (tutorialStatusMatches() && isOwnedAndClaimed() && !item_interface.isRepairing()) {
