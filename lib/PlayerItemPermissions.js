...
PlayerItemPermissions = function(player_interface, item_interface) {
	...
	var isOwned = function() {
		return item_interface.getOwnerId() == user_object._id;
	}
	...
	var artworkIsAlreadyPermanentOrDisplayed = function() {
		return getOneFromCollection("PlayerItemPermissions.js:PlayerItemPermissions.artworkIsAlreadyPermanentOrDisplayed()", items, {'owner': user_object._id, 'status': {$in: ["displayed", "permanent"]}, 'artwork_id': item_object.artwork_id}) != undefined;
	}
