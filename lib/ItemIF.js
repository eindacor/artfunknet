ItemIF = function(item) {
    ...
    this.isForgery = function() {
        return item_object.authenticity.forgery;
    }

    this.isIdentifiedForgery = function() {
        return item_object.authenticity.forgery && item_object.authenticity.identified;
    }
    ...
    this.punishLiable = function() {
        ...
        var money_penalty = Math.floor(this.getItemObject().authenticity.fee * 1.2);
        liable_player_interface.chargeAccount(money_penalty);
        liable_player_interface.increaseVisitorIgnorePenalty();
    ...
    this.punishForFalseForgeryRedemption = function() {
        ...
        owner_interface.increaseVisitorIgnorePenalty();
        ...
        this.updateItem(
            {
                $set: {
                    ...
                    'authenticity.forgery_quality': .05
                }
            }, false
        );
