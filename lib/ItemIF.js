ItemIF = function(item) {
    ...
    this.punishLiable = function() {
        ...
        var html = '<p>The forgery you sold, <span class="af-color" style="font-style:italic">' + item_object.artwork_data.title + '</span> by <span class="af-color">' + item_object.artwork_data.artist + '</span>, has been returned. You have been charged <span class="red-text">$' + getCommaSeparatedValue(money_penalty) + '</span> and have temporarily lost reputation.</p>';
    ...
    this.punishForFalseForgeryRedemption = function() {
        ...
        var html = '<p>You have falsely claimed <span class="af-color" style="font-style:italic">' + item_object.artwork_data.title + '</span> by <span class="af-color">' + item_object.artwork_data.artist + '</span> is a forgery, and temporarily lost reputation.</p>';
    ...
    this.punishForgeryOwner = function(owner_interface) {
        ...
        var html = '<p>Your forgery, <span class="af-color" style="font-style:italic">' + item_object.artwork_data.title + '</span> by <span class="af-color">' + item_object.artwork_data.artist + '</span>, has been identified. You have temporarily lost reputation.</p>';
        alertPlayers(owner_interface.getId(), html, 'fa-user-secret', 'bad');
    }
}