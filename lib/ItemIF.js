ItemIF = function(item) {
    ...
    this.isPatreon = function() {
        return item_object.patreon;
    }
    ...
    this.updateItem = function(modifier, suppress_gallery_update, callback) {
        items.update(item_id, modifier, function(error) {
            if (error)
                ...
                else if (nested_item_object.owner != BOT_USER_NAME) {
    ...
    // TODO code duplicated in PlayerArtworkIF.js
    ...
    this.punishLiable = function() {
        ...
        var html = '<p>The forgery you sold, <span class="' + item_object.artwork_data.rarity + '" style="font-style:italic">' + item_object.artwork_data.title + '</span> by <span class="af-color">' + item_object.artwork_data.artist + '</span>, has been returned. You have been charged <span class="red-text">$' + getCommaSeparatedValue(money_penalty) + '</span> and have temporarily lost reputation.</p>';
        alertPlayers(liable_player_interface.getId(), html, 'fa-user-secret', 'bad');
    }
    ...
    this.punishForFalseForgeryRedemption = function() {
        ...
        var html = '<p>You have falsely claimed <span class="' + item_object.artwork_data.rarity + '" style="font-style:italic">' + item_object.artwork_data.title + '</span> by <span class="af-color">' + item_object.artwork_data.artist + '</span> is a forgery, and temporarily lost reputation.</p>';
        alertPlayers(owner_interface.getId(), html, 'fa-user-secret', 'bad');
    }
    ...
    this.punishForgeryOwner = function(owner_interface) {
        ...
        var html = '<p>Your forgery, <span class="' + item_object.artwork_data.rarity + '" style="font-style:italic">' + item_object.artwork_data.title + '</span> by <span class="af-color">' + item_object.artwork_data.artist + '</span>, has been identified. You have temporarily lost reputation.</p>';
        alertPlayers(owner_interface.getId(), html, 'fa-user-secret', 'bad');
    }
}