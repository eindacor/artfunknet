PlayerItemIF = function(player_interface, item_interface) {
		...
		try {
			if (permissions.canRedeemForgery().result) {
				if (item_interface.getItemObject().authenticity.forgery) {
					...
					var html = '<p>You successfully returned <span class="af-color" style="font-style:italic">' + item_object.artwork_data.title + '</span> by <span class="af-color">' + item_object.artwork_data.artist + '</span>. You have been refunded <span class="green-text">$' + getCommaSeparatedValue(original_fee) + '</span> for your purchase, and you\'ve earned <span class="green-text">$' + getCommaSeparatedValue(bonus) + '</span> and <span class="af-color">' + getCommaSeparatedValue(xp_earned) + 'xp</span> as a reward.</p>';
	...
	this.makeLiable = function() {
		if (item_object.authenticity.liable == player_interface.getId()) {
			...
			var html = '<p>You have successfully offloaded a forgery (<span class="af-color" style="font-style:italic">' + item_object.artwork_data.title + '</span> by <span class="af-color">' + item_object.artwork_data.artist + '</span>), earning you XP.</p>';
