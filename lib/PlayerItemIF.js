PlayerItemIF = function(user_id, item_id) {
	...
	this.getDisplayValuePerHour = function() {
		var amount = getAverageDropValue(user_object.profile.level, 1);

	    switch(item_object.artwork_data.rarity) {
	        case "common": break;
	        case "uncommon": amount *= 5; break;
	        case "rare": amount *= 10; break;
	        case "legendary": amount *= 15; break;
	        case "masterpiece": amount *= 20; break;
	        default: break;
	    }
	    ...
	    amount = Math.floor(amount + (amount * item_object.condition * artwork_object.value_scale));
