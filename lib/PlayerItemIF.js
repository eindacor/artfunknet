		...
		try {
			if (permissions.canRedeemForgery()) {
				if (item_interface.getItemObject().authenticity.forgery) {
					...
					var message = "You successfully returned " + item_object.artwork_data.title + " by " + item_object.artwork_data.artist + ". You have been refunded $" + getCommaSeparatedValue(original_fee) + " for your purchase, and you've earned $" + getCommaSeparatedValue(bonus) + " and XP as a reward.";
