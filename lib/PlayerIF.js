PlayerIF = function(user) {
	...
	this.canForgeItem = function(forged_item_object, forgery_contract_object) {
		...
		var forge_base = getOneFromCollection("PlayerIF.js:canForgeItem", items, {'owner': user_id, 'status': {$in: valid_statuses}, 'artwork_id': artwork_id});
		if (forge_base == undefined) {
			return false;
		}
