PlayerIF = function(user) {
	...
	this.getForgeryCost = function(forged_item_object) {
		...
		var cost_adjuster = (FORGERY_COST_COEFFICIENT * forgery_quality_value_inverse_coefficient) + (FORGERY_COST_COEFFICIENT * forgery_quality_value_coefficient * forged_item_object.authenticity.forgery_quality)
