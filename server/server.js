...
var updateContent = function() {
    ...
    //temp code
    items.update({'status': {$ne: "repairing"}, 'repairing': {$ne: true}}, {$set: {'repairing': false}}, {multi: true});
    items.update({'status': "repairing"}, {$set: {'repairing': true, 'status': "claimed"}}, {multi: true});
    //temp code
